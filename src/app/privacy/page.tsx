  ...
  return (
    <main className="container" style={{ paddingTop: 'var(--spacing-xl)', paddingBottom: 'var(--spacing-xl)', minHeight: '60vh' }}>
      ...
      <div style={{ lineHeight: '1.8', maxWidth: '800px' }}>
        ...
        <p>This Privacy Notice for <strong>Legado</strong> ("we," "us," or "our"), describes how and why we might access, collect, store, use, and/or share ("process") your personal information when you use our services ("Services"), including when you:</p>
        <ul>
        ...
        <p><strong>Payment Data.</strong> We may collect data necessary to process your payment if you choose to make purchases. All payment data is handled and stored by Stripe. You may find their privacy notice at <a href="https://stripe.com/privacy">https://stripe.com/privacy</a>. Legado does not store or have access to your full card details. Bank account connections are handled by Plaid using read-only access.</p>

        <p><strong>Application Data.</strong> If you use our application(s), we may also collect:</p>
        <ul>
          <li><em>Mobile Device Access.</em> We may request access to certain features from your mobile device, including storage and reminders. You may change our access in your device's settings.</li>
          <li><em>Mobile Device Data.</em> We automatically collect device information such as your mobile device ID, model, manufacturer, operating system, browser type, IP address, and related configuration information.</li>
          <li><em>Push Notifications.</em> We may request to send you push notifications regarding your account. You may opt out in your device's settings.</li>
        </ul>
        ...
        <p>This information does not reveal your specific identity but may include device and usage data such as your IP address, browser and device characteristics, operating system, language preferences, and other technical information needed to maintain the security and operation of our Services.</p>
        <p>The information we collect includes:</p>
        <ul>
          <li><em>Log and Usage Data.</em> Service-related diagnostic, usage, and performance information our servers automatically collect, including IP address, device information, browser type, and activity in the Services.</li>
          <li><em>Device Data.</em> Information about your computer, phone, tablet, or other device used to access the Services.</li>
        </ul>

        <h3>Google API</h3>
        <p>Our use of information received from Google APIs will adhere to the <a href="https://developers.google.com/terms/api-services-user-data-policy">Google API Services User Data Policy</a>, including the Limited Use requirements.</p>
        ...
        <p>We may obtain information about you from public databases, joint marketing partners, affiliate programs, data providers, and other third parties to enhance our ability to provide relevant marketing and services to you.</p>
        ...
        <p><strong>Vendors, Consultants, and Other Third-Party Service Providers.</strong> We may share your data with third-party vendors who perform services for us. We have contracts in place with all third parties designed to safeguard your personal information.</p>
        ...
        <p>We may also share your personal information in connection with any merger, sale of company assets, financing, or acquisition of all or a portion of our business.</p>
        ...
        <p>We may use cookies and similar tracking technologies to gather information when you interact with our Services, helping us maintain security, prevent crashes, fix bugs, save preferences, and assist with basic site functions.</p>
        <p>We also permit third parties and service providers to use online tracking technologies on our Services for analytics and advertising purposes. For further information, please see our Cookie Notice at <a href="https://legado.vercel.app/cookies">https://legado.vercel.app/cookies</a>.</p>

        <h3>Google Analytics</h3>
        <p>We may share your information with Google Analytics to track and analyze the use of the Services. To opt out, visit <a href="https://tools.google.com/dlpage/gaoptout">https://tools.google.com/dlpage/gaoptout</a>.</p>
        ...
        <p>We provide AI Products through third-party service providers including OpenAI. Your input, output, and personal information will be shared with and processed by these AI Service Providers to enable your use of our AI Products. You must not use the AI Products in any way that violates the terms or policies of any AI Service Provider.</p>
        <p>Our AI Products are designed to enhance your financial management and insights experience within the Legado platform. All personal information processed using our AI Products is handled in line with this Privacy Notice.</p>
        <p><strong>How to Opt Out:</strong> You can opt out by logging in to your account settings and updating your preferences, or by contacting us directly.</p>
        ...
        <p>When we have no ongoing legitimate business need to process your personal information, we will either delete or anonymize it, or securely store and isolate it from any further processing until deletion is possible.</p>
        ...
        <p><strong>Withdrawing your consent:</strong> If we are relying on your consent to process your personal information, you have the right to withdraw your consent at any time by contacting us. This will not affect the lawfulness of processing before its withdrawal.</p>
        <p><strong>Opting out of marketing communications:</strong> You can unsubscribe from our marketing communications at any time by clicking the unsubscribe link in our emails or by contacting us. We may still send you service-related messages necessary for the administration of your account.</p>

        <h3>Account Information</h3>
        <p>To review or change the information in your account or terminate your account, log in to your account settings. Upon your request to terminate your account, we will deactivate or delete your account and information from our active databases. However, we may retain some information in our files to prevent fraud, troubleshoot problems, assist with investigations, or comply with legal requirements.</p>
        <p>If you have questions or comments about your privacy rights, email us at <a href="mailto:contact.support.legado@gmail.com">contact.support.legado@gmail.com</a>.</p>

        {/* SECTION 10 */}
        <h2 id="DNT">10. Controls for Do-Not-Track Features</h2>
        <p>Most web browsers and some mobile operating systems include a Do-Not-Track ("DNT") feature. Because there is currently no uniform technology standard for recognizing and implementing DNT signals, we do not currently respond to DNT browser signals. If a standard for online tracking is adopted that we must follow in the future, we will inform you about that practice in a revised version of this Privacy Notice.</p>
        ...
        <p>To exercise these rights, visit <a href="https://legado.vercel.app/contact">https://legado.vercel.app/contact</a> or email us at <a href="mailto:contact.support.legado@gmail.com">contact.support.legado@gmail.com</a>.</p>

        <h3>Appeals</h3>
        <p>If we decline to take action regarding your request, you may appeal our decision by emailing us at <a href="mailto:contact.support.legado@gmail.com">contact.support.legado@gmail.com</a>. If your appeal is denied, you may submit a complaint to your state attorney general.</p>

        <h3>California "Shine The Light" Law</h3>
        <p>California residents may request information about personal information we disclosed to third parties for direct marketing purposes once a year, free of charge. Submit your request in writing using the contact details in Section 13.</p>
        ...
        <p>We may update this Privacy Notice from time to time. The updated version will be indicated by an updated "Revised" date at the top of this Privacy Notice. If we make material changes, we may notify you by posting a prominent notice or by sending you a notification directly. We encourage you to review this Privacy Notice frequently.</p>
        ...
        <p>Or by email at <a href="mailto:contact.support.legado@gmail.com">contact.support.legado@gmail.com</a>.</p>

        {/* SECTION 14 */}
        <h2 id="request">14. How Can You Review, Update, or Delete the Data We Collect From You?</h2>
        <p>Based on the applicable laws of your country or state of residence, you may have the right to request access to the personal information we collect from you, correct inaccuracies, or delete your personal information. To request to review, update, or delete your personal information, please visit: <a href="https://legado.vercel.app/contact">https://legado.vercel.app/contact</a>.</p>
